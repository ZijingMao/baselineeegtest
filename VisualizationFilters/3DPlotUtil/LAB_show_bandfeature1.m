function LAB_show_bandfeature2(logic_values, channel_locs, freqs, width, height)
...
[number_of_channels,bbb,feature_samples] = size(logic_values);
...
fps = 1;%feature_samples/...                          % Frames per Second
