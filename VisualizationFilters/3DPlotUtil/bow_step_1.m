function [section_A, section_B, conf_struct] = bow_step_1(conf_struct)
...
% Section A from the LOW TASK LOAD group = section 1 of the mission


load ICA_results

ICA_mission = ICA_restult{conf_struct.TX_subject};

section_A = ICA_mission(:,event_location(1,conf_struct.sec1(1)):...
...
section_B = ICA_mission(:,event_location(1,conf_struct.sec2(1)):...
