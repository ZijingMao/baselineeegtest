...
if responseLocked
    ...
    local_urevent_latency = urevent(local_urevent_start_time:urevent_start_time).latency;
...
for idx = 1:length(epoch)-1
    ...
    if ~responseLocked
        ...
        % Not likely to have more than 100 events in 20 seconds, probably
        % much less
        local_urevent_start_time = max(urevent_next_time - 99, 1);
        local_urevent_latency = urevent(local_urevent_start_time:urevent_next_time).latency;
